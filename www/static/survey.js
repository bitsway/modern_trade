...
//				npdStringShow=npdStringShow+'<tr height="1px" bgcolor="#CCCCCC" ><td></td><td></td><td> </td><td ></td></tr>'
	...
	//=====================Create Fixed Display list
			...
			for (var slab=0; slab < fdisplaySlabTotal-1; slab++){
					...
					fdisplayStringShow=fdisplayStringShow+'</br></br><table width="100%" border="0"> <tr><td style=" font-weight:bold; font-size:28px color:#006A6A; background:#FFECFF">'+  +'</td> </tr></table>';
